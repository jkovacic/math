 ...
 *
 * Declaration and implementation of the class RationalGeneric, representing
 * mathematical rational numbers, i.e. reduced fractions of two integers.
 */
...
template <typename I>
RationalGeneric<I> operator+(const RationalGeneric<I>& f1, const RationalGeneric<I>& f2);

template <typename I>
RationalGeneric<I> operator+(const RationalGeneric<I>& f, const I& i);

template <typename I>
RationalGeneric<I> operator+(const I& i, const RationalGeneric<I>& f);
...
namespace RationalNS {  namespace __private
{
...
public:
     ...
     * @return reference to itself
     */
    RationalGeneric<I>& operator=(const RationalGeneric<I>& frac)
    {
        /*
