 ...
 *
 * Declaration and implementation of the class PolynomialFittingGenericAb.h
 * that calculates a regression polynomial using the method of least squares.
 */
...
public:
     ...
     */
    void generateCurve(const std::size_t degree = 1)
    {
