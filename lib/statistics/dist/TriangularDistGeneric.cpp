 ...
 *
 * Implementation of functions within the namespace TriangularDist
...
// No #include "TriangularDistGeneric.hpp" !!!
#include <algorithm>
#include <cmath>
...
namespace math {  namespace TriangularDist {  namespace __private
{
