 ...
 *
 * Implementation of functions within the namespace FDist that perform
 * various F-distribution (a.k.a. Fisher - Snedecor distribution) related
 * operations, such as calculation of upper and lower tail probabilities
...
namespace math {  namespace FDist {  namespace __private
{
