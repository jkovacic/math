 ...
 * @headername{LogNormalDist.h}
 *
 * Declaration of functions within the namespace LogNormalDist
...
#ifndef _MATH_LOGNORMALDISTGENERIC_HPP_
#define _MATH_LOGNORMALDISTGENERIC_HPP_
 ...
 * various log-normal distribution related operations, such as
 * calculation of upper and lower tail probabilities and
 * quantiles, calculation of z statistics, probability
 * distribution function, etc.
 */
namespace LogNormalDist
{
...
// DEFINITION
#include "statistics/dist/LogNormalDistGeneric.cpp"

#endif  // _MATH_LOGNORMALDISTGENERIC_HPP_
