 ...
 * @param error code
 */
math::IntFactorizationException::IntFactorizationException(const math::IntFactorizationException::err_codes err)
{
    this->error = err;
}
...
void math::IntFactorizationException::what(std::ostream& str) const
{
    switch (error)
    {
        case math::IntFactorizationException::OUT_OF_RANGE :
            ...
            break;
        case math::IntFactorizationException::INVALID_INPUT :
            str << "Operation not defined for this input argument.";
            break;
        case math::IntFactorizationException::NEGATIVE_ARG :
            str << "Negative input arguments are not allowed.";
            break;
        case math::IntFactorizationException::OUT_OF_MEMORY :
