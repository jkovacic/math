 ...
 *
 * Declaration and implementation of the namespace NumericUtil with a
 * collection of some useful numerical utilities.
 */
 ...
 */
template <class T>
inline bool isZero(const T& value, const T& eps)
{
    /*
 ...
 */
template <class T>
inline T smallValToZero(const T& val, const T& eps)
{
 ...
 */
template <class T>
inline T smallValToZero(const T& val)
{
    return
