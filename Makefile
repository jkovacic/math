...
DEP_NORMDIST = $(LIBSTATDIR)NormalDistGeneric $(DEP_NUMUTIL) $(DEP_MATHCONST) $(DEP_STAT_SETTINGS) $(DEP_SPECFUN)
DEP_STUDDIST = $(LIBSTATDIR)StudentDistGeneric $(DEP_NUMUTIL) $(DEP_STAT_SETTINGS) $(DEP_MATHCONST) $(DEP_IFUNCTION) $(DEP_SPECFUN) $(DEP_ROOTFIND)
