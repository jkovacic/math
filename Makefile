...
TESTLINKOBJ += probdistTest $(OBJDEP_NORMDIST) $(OBJDEP_STUDDIST) $(OBJDEP_CHISQDIST) $(OBJDEP_FDIST) $(OBJDEP_CONTUNIFDIST) \
                            $(OBJDEP_TRIANGULARDIST) $(OBJDEP_BINOMDIST) $(OBJDEP_POISSONDIST) $(OBJDEP_EXPONENTIALDIST)
...
TEST_PROBDIST_GENDEP = $(DEP_NORMDIST) $(DEP_STUDDIST) $(DEP_CHISQDIST) $(DEP_FDIST) $(DEP_CONTUNIFDIST) \
                       $(DEP_TRIANGULARDIST) $(DEP_BINOMDIST) $(DEP_POISSONDIST) $(DEP_EXPONENTIALDIST)
