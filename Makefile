...
DEP_MATRIX = $(LIBMATRIXDIR)MatrixGeneric $(DEP_MTCOPY) $(DEP_MTVECTOP) $(DEP_OMPSETTINGS) $(DEP_OMPHEADER) $(DEP_OMPCOARSE) $(DEP_NUMUTIL)
DEP_SQMATRIX = $(LIBMATRIXDIR)SqMatrixGeneric $(DEP_NUMUTIL) $(DEP_MTCOPY) $(LIBMATRIXDIR)LinearEquationSolverGeneric $(DEP_OMPSETTINGS) $(DEP_OMPHEADER) $(DEP_OMPCOARSE)
DEP_LINEQ = $(LIBMATRIXDIR)LinearEquationSolverGeneric $(DEP_NUMUTIL) $(DEP_MATRIX) $(DEP_SQMATRIX) $(DEP_OMPSETTINGS)
...
DEP_NORMDIST = $(LIBSTATDISTDIR)NormalDistGeneric $(DEP_NUMUTIL) $(DEP_STAT_SETTINGS) $(DEP_MATHCONST) $(DEP_SPECFUN)
DEP_STUDDIST = $(LIBSTATDISTDIR)StudentDistGeneric $(DEP_NUMUTIL) $(DEP_STAT_SETTINGS) $(DEP_MATHCONST) $(DEP_SPECFUN)
DEP_CHISQDIST = $(LIBSTATDISTDIR)ChiSquareDistGeneric $(DEP_NUM_UTIL) $(DEP_STAT_SETTINGS) $(DEP_SPECFUN)
DEP_FDIST = $(LIBSTATDISTDIR)FDistGeneric $(DEP_NUM_UTIL) $(DEP_STAT_SETTINGS) $(DEP_SPECFUN)
DEP_CONTUNIFDIST = $(LIBSTATDISTDIR)ContUniformDistGeneric $(DEP_NUM_UTIL)
DEP_BINOMDIST = $(LIBSTATDISTDIR)BinomDistGeneric $(DEP_STAT_SETTINGS) $(DEP_NUM_UTIL) $(DEP_SPECFUN) $(DEP_INTUTIL) $(DEP_INTEXP) $(DEP_INTCOMB)
DEP_POISSONDIST = $(LIBSTATDISTDIR)PoissonDistGeneric $(DEP_STAT_SETTINGS) $(DEP_NUM_UTIL) $(DEP_SPECFUN) $(DEP_INTUTIL) $(DEP_INTEXP)
