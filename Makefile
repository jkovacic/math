...
DEP_SAMPLEQUANTSORTEDARRAY = $(LIBSTATDIR)SampleQuantileSortedArrayGeneric $(DEP_SAMPLEQUANTAB) $(DEP_MTCOPY)
...
TEST_STAT_GENDEP = $(DEP_MTCOPY) $(DEP_SAMPLESTAT) $(DEP_SAMPLEQUANTSORTEDARRAY)
