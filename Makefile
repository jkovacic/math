...
DEP_INTFACT = $(LIBINTUTILDIR)IntFactorizationGeneric
DEP_INTEXP = $(LIBINTUTILDIR)IntExponentiatorGeneric
...
DEP_SAMPLEQUANT = $(LIBSTATDIR)SampleQuantileGeneric $(DEP_STAT_SETTINGS) $(DEP_NUMUTIL) $(DEP_MTCOPY)
...
TEST_STAT_GENDEP = $(DEP_MTCOPY) $(DEP_SAMPLESTAT) $(DEP_SAMPLEQUANT) $(DEP_NORMDIST) $(DEP_STUDDIST) $(DEP_CHISQDIST) $(DEP_FDIST)
