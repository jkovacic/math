...
DEP_NORMDIST = $(LIBSTATDIR)NormalDistGeneric $(DEP_NUMUTIL) $(DEP_STAT_SETTINGS) $(DEP_MATHCONST) $(DEP_SPECFUN)
DEP_STUDDIST = $(LIBSTATDIR)StudentDistGeneric $(DEP_NUMUTIL) $(DEP_STAT_SETTINGS) $(DEP_MATHCONST) $(DEP_SPECFUN)
DEP_CHISQDIST = $(LIBSTATDIR)ChiSquareDistGeneric $(DEP_NUM_UTIL) $(DEP_STAT_SETTINGS) $(DEP_SPECFUN)
DEP_FDIST = $(LIBSTATDIR)FDistGeneric $(DEP_NUM_UTIL) $(DEP_STAT_SETTINGS) $(DEP_SPECFUN)
