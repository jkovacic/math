...
DEP_FILLVECTORS = $(LIBUTILDIR)FillVectors.h $(DEP_OMPSETTINGS) $(DEP_OMPHEADER) $(DEP_OMPCOARSE)
...
DEP_LOGNORMDIST = $(LIBPROBDISTDIR)LogNormalDistGeneric $(DEP_NUMUTIL) $(DEP_PROBDIST_SETTINGS) $(DEP_MATHCONST) $(DEP_SPECFUN)
...
DEP_EXPONENTIALDIST = $(LIBPROBDISTDIR)ExponentialDistGeneric $(DEP_NUM_UTIL)
...
OBJDEP_LOGNORMDIST = StatisticsException $(OBJDEP_SPECFUN) $(OBJDEP_NUMUTIL)
...
OBJDEP_EXPONENTIALDIST = StatisticsException $(OBJDEP_NUMUTIL)
...
TESTLINKOBJ += probdistTest $(OBJDEP_NORMDIST) $(OBJDEP_LOGNORMDIST) $(OBJDEP_STUDDIST) $(OBJDEP_CHISQDIST) $(OBJDEP_FDIST) \
                            $(OBJDEP_CONTUNIFDIST) $(OBJDEP_TRIANGULARDIST) $(OBJDEP_BINOMDIST) $(OBJDEP_POISSONDIST) \
                            $(OBJDEP_EXPONENTIALDIST)
...
TEST_PROBDIST_GENDEP = $(DEP_NORMDIST) $(DEP_LOGNORMDIST) $(DEP_STUDDIST) $(DEP_CHISQDIST) $(DEP_FDIST) \
